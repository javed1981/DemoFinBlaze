...
public class TC_22_RemoveFromCart {
	...
	public void TestMethod() throws InterruptedException 
	{
		//Launch firefox browser 
			    ...
			    new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='loginusername']"))).sendKeys("javed123456rqwrqr");
			   ...
			   new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Delete')]"))).click();
			   Thread.sleep(3000);
			   //new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//th[contains(text(),'Pic')]"))).click();
               String fetchvalue =driver.findElement(By.xpath("//h3[@id='totalp']")).getText();
               System.out.println(fetchvalue);
               //if value is null for amount means no product selected product is removed
               Assert.assertEquals("",driver.findElement(By.xpath("//h3[@id='totalp']")).getText() );
